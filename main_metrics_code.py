...
"""print(str(rds_1_1_df))
print(str(rds_1_2_df))
print(str(rds_1_3_df))
print(str(rds_1_4_df))
print(str(rds_1_5_df))
print(str(rds_1_6_df))
print(str(rds_2_1_df))
print(str(rds_2_2_df))
print(str(rds_2_3_df))
print(str(rds_2_4_df))
print(str(rds_2_5_df))
print(str(rds_2_6_df))
print(str(rs_1_1_df))
print(str(rs_1_2_df))
print(str(rs_1_3_df))
print(str(rs_2_1_df))
...
"""document = Document()
head = document.add_heading('Status Monitoring Report',0)
head.alignment = 1
#paragraph = document.add_paragraph("This is a sample text")
#paragraph.alignment = 1

document.add_picture('rds_1_1_CPU.png', width=Inches(7.5))
document.add_picture('rds_1_2_DB_Connection.png', width=Inches(7.5))
last_paragraph = document.paragraphs[-1] 
last_paragraph.alignment = WD_ALIGN_PARAGRAPH.CENTER

document.save('Final Monitoring.docx')"""